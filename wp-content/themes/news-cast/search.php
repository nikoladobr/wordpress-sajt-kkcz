						...
						<header class="page-header">
							<h1 class="page-title">
								<?php
									...
									printf( esc_html__( '%1$s %2$1s', 'news-cast' ), esc_html( get_theme_mod( 'search_page_title', esc_html__( 'Search Results for:', 'news-cast' ) ) ), '<span>' . get_search_query() . '</span>' );
								?>
							</h1>
						</header><!-- .page-header -->
						...
						<div class="bmm-post-wrapper">
							<?php
								...
								while ( have_posts() ) :
									 ...
									 * 
									 * @hooked - news_cast_archive_read_more_button
									 */
