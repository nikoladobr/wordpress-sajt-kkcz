 ...
 * 
 */
class Style_Mag_Post_Grid_Element extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Post Grid', 'news-cast' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'   => esc_html__( 'News Cast Post Grid Title', 'news-cast' ),
    ...
    protected function render() {
        ...
        echo '<div id="bmm-post-grid-block-'.esc_attr( $element_id ).'" class="bmm-post-grid-block block-'.esc_attr( $element_id ).' bmm-block bmm-block-post-grid--layout-one bmm-block-image-hover--'.esc_html( $imageHoverType ).'">';
            if( !empty( $blockTitle ) ) {
                echo '<h2 class="bmm-block-title"><span>'.esc_html( $blockTitle ).'</span></h2>';
            }
            // include template file w.r.t  layout value
            include( NEWS_CAST_INCLUDES_PATH .'elementor-widgets/post-grid/template.php' );
        echo '</div><!-- #bmm-post-grid-block -->';
    }
}